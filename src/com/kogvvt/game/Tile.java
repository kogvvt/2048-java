...
public class Tile {
	...
	private void drawImage() {
		 ...
		 * TODO:
		 * 
		 * Color[] colorArray; colorArray = new Color[12];
		 * 
		 * colorArray[0] = burgundowykutacz17 write all background colors and text
		 * colors
		 * 
		 *
		 * for(int i = 1 ;i<=2048; i*=2){
		 * 
		 * if(value == i){ background = colorArray[Math.log(i)/Math.log(2)];
		 * if(value>4){ text = new Color (0xfffffffff); } }
		 * 
		 * }
		 * 
		 */
